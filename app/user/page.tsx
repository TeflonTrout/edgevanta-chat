...
const User = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full bg-zinc-200 dark:bg-zinc-500 dark:text-white ">
              ...
              >
                ...
                <div className="flex justify-between items-center gap-4">
                  <Link
                    ...
                    className="flex justify-between items-center hover:scale-150 duration-200 cursor-pointer"
                  >
                    <svg
                      fill="#BBB"
                      height="30"
      ...
      <Link
        href="/create"
        className="text-2xl bg-zinc-800 flex justify-center items-center text-center px-4 py-2 mt-4 rounded text-zinc-200 hover:bg-zinc-500 transition-colors"
      >
        New User
      </Link>
    </div>
